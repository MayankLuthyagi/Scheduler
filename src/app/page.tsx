        ...
        <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
            <div className="w-full max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 bg-white shadow-2xl rounded-xl overflow-hidden">
                ...
                <div className="p-8 sm:p-12 flex flex-col justify-center">
                    ...
                    <div className="mb-6">
                        ...
                        <div className="w-60 bg-white rounded flex items-center justify-center">
                           {settings.textLogo ? (
                               <img src={`/uploads/${settings.textLogo}?t=${Date.now()}`} alt="Company Logo" />
                           ) : (
                               <img src="/uploads/textlogo.png" alt="Company Logo" />
                           )}
                        </div>
                    </div>
                ...
                <div className="hidden md:block bg-gray-800">
                    ...
                    {settings.logo ? (
                        <img src={`/uploads/${settings.logo}?t=${Date.now()}`} alt="Campaign Illustration" className="object-contain h-full w-full" />
                    ) : (
                        <img src="/uploads/logo.png" alt="Campaign Illustration" className="object-contain h-full w-full" />
                    )}
                </div>
            </div>
        </div>
